    ...
    <div :id="uniqueId!" class="carousel carousel-dark slide">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active" data-bs-interval="10000">
          <svg class="bd-placeholder-img bd-placeholder-img-lg d-block w-100" width="800" height="400" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: First slide" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#f5f5f5" data-darkreader-inline-fill="" style="--darkreader-inline-fill: #1e2021;"></rect><text x="50%" y="50%" fill="#aaa" dy=".3em" data-darkreader-inline-fill="" style="--darkreader-inline-fill: #b2aca2;">First slide</text></svg>
        ...
        <div class="carousel-item" data-bs-interval="2000">
          <svg class="bd-placeholder-img bd-placeholder-img-lg d-block w-100" width="800" height="400" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Second slide" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#eee" data-darkreader-inline-fill="" style="--darkreader-inline-fill: #dddad6;"></rect><text x="50%" y="50%" fill="#bbb" dy=".3em" data-darkreader-inline-fill="" style="--darkreader-inline-fill: #bdb7af;">Second slide</text></svg>
          <div class="carousel-caption d-none d-md-block">
        ...
        <div class="carousel-item">
          <svg class="bd-placeholder-img bd-placeholder-img-lg d-block w-100" width="800" height="400" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Third slide" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#e5e5e5" data-darkreader-inline-fill="" style="--darkreader-inline-fill: #d8d4cf;"></rect><text x="50%" y="50%" fill="#999" dy=".3em" data-darkreader-inline-fill="" style="--darkreader-inline-fill: #a8a095;">Third slide</text></svg>
          <div class="carousel-caption d-none d-md-block">
