    ...
    <main class="container-fluid d-flex flex-row">
      ...
      <div v-if="user"
           :class="(chatWindowIsOpen) ?
             'd-flex d-sm-flex w-100 h-100'
             : 'd-none d-sm-none d-md-flex w-100 h-100'"
      >
        <button v-if="chatWindowIsOpen" @click="chatWindowIsOpen = false">Close Chat</button>
        <ChatComponent/>
      </div>
